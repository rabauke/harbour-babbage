...
Page {
  ...
  SilicaFlickable {
    ...
    Column {
      ...
      SectionHeader {
        text: qsTr('Units of angle conversion')
      }
      FunctionDoc {
        functionText: 'deg(x)'
      ...
      SectionHeader {
        text: qsTr('Trigonometric functions')
      }
      FunctionDoc {
        functionText: 'sin(x)'
      ...
      SectionHeader {
        text: qsTr('Inverse trigonometric functions')
      }
      FunctionDoc {
        functionText: 'asin(x)'
      ...
      SectionHeader {
        text: qsTr('Hyperbolic functions')
      }
      FunctionDoc {
        functionText: 'sinh(x)'
      ...
      SectionHeader {
        text: qsTr('Inverse hyperbolic functions')
      }
      FunctionDoc {
      ...
      SectionHeader {
        text: qsTr('Exponential and related functions')
      }
      FunctionDoc {
        functionText: 'exp(x)'
      ...
      SectionHeader {
        text: qsTr('Error functions and related functions')
      }
      FunctionDoc {
        functionText: 'erf(x)'
      ...
      SectionHeader {
        text: qsTr('Gamma function and related functions')
      }
      FunctionDoc {
      ...
      SectionHeader {
        text: qsTr('Statistical functions')
      }
      FunctionDoc {
